...
class HomeGuaranteeIncomeAreaOutNoOrderDraggableScrollableSheet
    extends StatefulWidget {
  const HomeGuaranteeIncomeAreaOutNoOrderDraggableScrollableSheet({super.key});

  @override
  State<HomeGuaranteeIncomeAreaOutNoOrderDraggableScrollableSheet>
  createState() =>
      _HomeGuaranteeIncomeAreaOutNoOrderDraggableScrollableSheetState();
}

class _HomeGuaranteeIncomeAreaOutNoOrderDraggableScrollableSheetState
    extends State<HomeGuaranteeIncomeAreaOutNoOrderDraggableScrollableSheet> {
