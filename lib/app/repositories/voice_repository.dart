...
class VoiceRepository {
  ...
  Future<List<Voice>> getVoiceList({required int language}) async {
    try {
      var url = "$baseUrl/app/api/voice/queryVoiceList";
      ...
      for (var voice in response.data['data']) {
        voiceList.add(Voice.fromJson(voice));
      }
